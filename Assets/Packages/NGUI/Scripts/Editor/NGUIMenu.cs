...
static public class NGUIMenu
{
	...
	[MenuItem("NGUI/Create/CardContent", false, 6)]
	...
	[MenuItem("NGUI/Open/CardContent Tool", false, 9)]
	static public void OpenPanelWizard ()
	{
		EditorWindow.GetWindow<UIPanelTool>(false, "CardContent Tool", true).Show();
	}
