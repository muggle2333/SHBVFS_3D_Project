...
/// <summary>
/// UI CardContent is responsible for collecting, sorting and updating widgets in addition to generating widgets' geometry.
/// </summary>

[ExecuteInEditMode]
[AddComponentMenu("NGUI/UI/CardContent")]
public class UIPanel : UIRect
{
	...
	// CardContent's alpha (affects the alpha of all widgets)
	...
	/// <summary>
	/// CardContent's alpha affects everything drawn by the panel.
	/// </summary>
	...
	/// <summary>
	/// CardContent's width in pixels.
	/// </summary>

	public float width { get { return GetViewSize().x; } }

	/// <summary>
	/// CardContent's height in pixels.
	/// </summary>
	...
	/// <summary>
	/// CardContent's size -- which is either the clipping rect, or the screen dimensions.
	/// </summary>
